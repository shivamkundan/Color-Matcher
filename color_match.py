...
def color_match_by_rgb(input_color,df):
	...
	return min_code,min_diff_rgb,min_diff,min_name
...
if __name__ == "__main__":
	...
	while True:
		...
		# Find closest match
		min_code,min_diff_rgb,min_diff,min_name=color_match_by_rgb(in_color_code,df)

		# HELVETICA.render_to(screen, (30,80), f"closest:", white,style=0,size=18)
		HELVETICA.render_to(screen, (30,100), f"{min_name}", white,style=0,size=18)
		HELVETICA.render_to(screen, (30,120), f"{min_code}", white,style=0,size=18)
